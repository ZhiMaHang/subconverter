...
int script_context_init(qjs::Context &context)
{
    try
    {
        ...
        module.class_<Proxy>("Proxy")
            ...
            .fun<&Proxy::Security>("Security")
            .fun<&Proxy::Flow>("Flow")
            .fun<&Proxy::PacketEncoding>("PacketEncoding")
            .fun<&Proxy::ClientFingerprint>("ClientFingerprint")
            .fun<&Proxy::RealityPublicKey>("RealityPublicKey")
            .fun<&Proxy::RealityShortId>("RealityShortId")
            .fun<&Proxy::RealitySpiderX>("RealitySpiderX")
            .fun<&Proxy::GRPCMode>("GRPCMode")
            .fun<&Proxy::XHTTPMode>("XHTTPMode")
            .fun<&Proxy::XHTTPExtra>("XHTTPExtra")
            .fun<&Proxy::MaxEarlyData>("MaxEarlyData")
            .fun<&Proxy::EarlyDataHeaderName>("EarlyDataHeaderName")
            .fun<&Proxy::Alpn>("Alpn")
            .fun<&Proxy::Host>("Host")
            .fun<&Proxy::Path>("Path")
            .fun<&Proxy::Edge>("Edge")
